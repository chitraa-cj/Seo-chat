...
function generateObjectType({ composer, concreteEntityAdapter, features, subgraph, userDefinedFieldDirectives, userDefinedObjectDirectives, propagatedDirectives, aggregationTypesMapper, node, seenRelationshipPropertiesTypes, userDefinedDirectivesForNode, userDefinedFieldDirectivesForNode, }) {
    ...
    if (concreteEntityAdapter.isAggregable) {
        ...
        if ((0, utils_2.shouldAddDeprecatedFields)(features, "deprecatedAggregateOperations")) {
            composer.Query.addFields({
            ...
            composer.Query.setFieldDirectives(concreteEntityAdapter.operations.rootTypeFieldNames.aggregate, [
                ...
                (0, constants_2.DEPRECATE_AGGREGATION)(concreteEntityAdapter),
            ]);
        }
    }
    ...
    if (interfaceEntityAdapter.isAggregable) {
        ...
        if ((0, utils_2.shouldAddDeprecatedFields)(features, "deprecatedAggregateOperations")) {
            ...
            composer.Query.setFieldDirectives(interfaceEntityAdapter.operations.rootTypeFieldNames.aggregate, [
                ...(0, to_compose_1.graphqlDirectivesToCompose)(propagatedDirectives),
                (0, constants_2.DEPRECATE_AGGREGATION)(interfaceEntityAdapter),
            ]);
        }
    }
}

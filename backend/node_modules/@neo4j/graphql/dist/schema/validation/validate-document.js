...
const deprecated_private_1 = require("./custom-rules/warnings/deprecated-private");
const deprecated_unique_1 = require("./custom-rules/warnings/deprecated-unique");
...
const query_direction_deprecated_values_1 = require("./custom-rules/warnings/query-direction-deprecated-values");
const single_relationship_1 = require("./custom-rules/warnings/single-relationship");
const subscriptions_authorization_missing_1 = require("./custom-rules/warnings/subscriptions-authorization-missing");
const warn_if_type_is_not_marked_as_node_1 = require("./custom-rules/warnings/warn-if-type-is-not-marked-as-node");
...
function runValidationRulesOnFilteredDocument({ schema, document, extra, userCustomResolvers, features, }) {
    const errors = (0, validate_sdl_1.validateSDL)(document, [
        ...
        single_relationship_1.WarnIfSingleRelationships,
        ...
        (0, warn_if_type_is_not_marked_as_node_1.WarnIfTypeIsNotMarkedAsNode)(),
        query_direction_deprecated_values_1.WarnIfQueryDirectionIsUsedWithDeprecatedValues,
        (0, deprecated_unique_1.WarnUniqueDeprecation)(),
        (0, deprecated_private_1.WarnPrivateDeprecation)(),
    ], schema);

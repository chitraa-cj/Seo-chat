...
exports.WarnIfSingleRelationships = void 0;
const graphql_1 = require("graphql");
const directives_1 = require("../../../../graphql/directives");
function WarnIfSingleRelationships() {
        ...
        FieldDefinition(field) {
            if (!warningAlreadyIssued) {
                ...
                if (isRelationship && !isList) {
                    console.warn("Using @relationship directive on a non-list element is deprecated and will be removed in next major version.");
...
exports.WarnIfSingleRelationships = WarnIfSingleRelationships;
...
//# sourceMappingURL=single-relationship.js.map
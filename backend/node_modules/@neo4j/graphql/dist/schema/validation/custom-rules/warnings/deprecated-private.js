...
exports.WarnPrivateDeprecation = void 0;
const directives_1 = require("../../../../graphql/directives");
function WarnPrivateDeprecation() {
    return function () {
            ...
            ObjectTypeDefinition(objectTypeDefinition) {
                ...
                for (const field of objectTypeDefinition.fields || []) {
                    for (const directive of field.directives ?? []) {
                        if (directive.name.value === directives_1.privateDirective.name) {
...
exports.WarnPrivateDeprecation = WarnPrivateDeprecation;
//# sourceMappingURL=deprecated-private.js.map
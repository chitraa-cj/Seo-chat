...
exports.WarnUniqueDeprecation = void 0;
const directives_1 = require("../../../../graphql/directives");
function WarnUniqueDeprecation() {
    return function () {
            ...
            ObjectTypeDefinition(objectTypeDefinition) {
                ...
                for (const field of objectTypeDefinition.fields || []) {
                    for (const directive of field.directives ?? []) {
                        if (directive.name.value === directives_1.uniqueDirective.name) {
...
exports.WarnUniqueDeprecation = WarnUniqueDeprecation;
//# sourceMappingURL=deprecated-unique.js.map
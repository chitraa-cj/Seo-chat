...
exports.withArrayOperators = exports.withMathOperators = exports.concreteEntityToUpdateInputFields = exports.concreteEntityToCreateInputFields = exports.attributeAdapterToComposeFields = exports.graphqlDirectivesToCompose = exports.graphqlArgsToCompose = void 0;
...
function concreteEntityToUpdateInputFields({ objectFields, userDefinedFieldDirectives, additionalFieldsCallbacks = [], features, }) {
    ...
    for (const field of objectFields) {
        ...
        if ((0, utils_1.shouldAddDeprecatedFields)(features, "implicitSet")) {
            updateInputFields[field.name] = {
                type: newInputField.type,
                directives: newInputField.directives?.length ? newInputField.directives : [constants_2.DEPRECATE_IMPLICIT_SET],
            };
        }

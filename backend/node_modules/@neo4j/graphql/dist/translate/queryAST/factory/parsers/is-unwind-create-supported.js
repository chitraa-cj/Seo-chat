...
exports.isUnwindCreateSupported = exports.UNSUPPORTED_REASON_CONNECT_OR_CREATE = exports.UNSUPPORTED_REASON_CONNECT = exports.UNSUPPORTED_REASON_POPULATED_BY = exports.UNSUPPORTED_REASON_ABSTRACT_TYPES = exports.UNSUPPORTED_REASON_SUBSCRIPTION = void 0;
...
exports.UNSUPPORTED_REASON_CONNECT_OR_CREATE = "Operation: connectOrCreate is not yet supported";
const SUPPORTED = {
    isSupported: true,
    reason: "",
};
...
function checkOperation(args) {
    ...
    if (args.connectOrCreate) {
        return {
            isSupported: false,
            reason: exports.UNSUPPORTED_REASON_CONNECT_OR_CREATE,
        };
    }
    return SUPPORTED;
}

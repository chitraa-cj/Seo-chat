...
function createAuthorizationBeforeAndParams({ context, nodes, operations, indexPrefix, }) {
    ...
    if (predicateReturn) {
        return (0, compile_predicate_return_1.compilePredicateReturn)({ predicateReturn, indexPrefix: `${indexPrefix || "_"}before_`, context });
    }
    return undefined;
}
...
function createAuthorizationBeforeAndParamsField({ context, nodes, operations, }) {
    ...
    if (predicateReturn) {
        return (0, compile_predicate_return_1.compilePredicateReturn)({ predicateReturn, indexPrefix: "_before_", context });
    }
    return undefined;
}
